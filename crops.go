...
var cropsByGroup = map[CropGroup][]Crop{
	...
	CropGroupFlower: {
		...
		{Name: "Woad Leaves", Value: "woad", Duration: 20 * time.Minute, WikiTitle: "Woad leaf"},
		{Name: "Limpwurt Root", Value: "limpwurt", Duration: 20 * time.Minute, WikiTitle: "Limpwurt root"},
	...
	CropGroupTree: {
		{Name: "Oak Tree", Value: "oak", Duration: 160 * time.Minute, WikiTitle: "Oak tree (Farming)"},
		{Name: "Willow Tree", Value: "willow", Duration: 4 * time.Hour, WikiTitle: "Willow tree (Farming)"},
		{Name: "Maple Tree", Value: "maple", Duration: 320 * time.Minute, WikiTitle: "Maple tree (Farming)"},
		{Name: "Yew Tree", Value: "yew", Duration: 400 * time.Minute, WikiTitle: "Yew tree (Farming)"},
		{Name: "Magic", Value: "magic", Duration: 8 * time.Hour, WikiTitle: "Magic tree (Farming)"},
	},
	CropGroupFruitTree: {
		{Name: "Apple Tree", Value: "apple", Duration: 16 * time.Hour, WikiTitle: "Apple tree"},
		{Name: "Banana Tree", Value: "banana", Duration: 16 * time.Hour, WikiTitle: "Banana tree (Farming)"},
		{Name: "Orange Tree", Value: "orange", Duration: 16 * time.Hour, WikiTitle: "Orange tree"},
		{Name: "Curry Tree", Value: "curry", Duration: 16 * time.Hour, WikiTitle: "Curry tree"},
		{Name: "Pineapple Tree", Value: "pineapple", Duration: 16 * time.Hour, WikiTitle: "Pineapple plant"},
		{Name: "Papaya Tree", Value: "papaya", Duration: 16 * time.Hour, WikiTitle: "Papaya tree"},
		{Name: "Palm Tree", Value: "palm", Duration: 16 * time.Hour, WikiTitle: "Palm tree"},
		{Name: "Dragonfruit Tree", Value: "dragonfruit", Duration: 16 * time.Hour, WikiTitle: "Dragonfruit tree"},
	},
	CropGroupCactus: {
	...
	CropGroupCelastrus: {
		{Name: "Celastrus Tree", Value: "celastrus", Duration: 800 * time.Minute, WikiTitle: "Celastrus tree"},
	},
	CropGroupRedwood: {
		{Name: "Redwood Tree", Value: "redwood", Duration: 6400 * time.Minute, WikiTitle: "Redwood tree (Farming)"},
	},
	CropGroupSpiritTree: {
